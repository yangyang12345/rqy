                ...
                <div class="box-body">
                    <form class="form-horizontal" action="{{ route('explain') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control m-b" id="otype" name="otype" required="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control m-b" id="etype" name="etype" required="">
                                    <option value="0">浏览错商品或店铺</option>
                                    <option value="1">问题任务</option>
                                    <option value="2">用户做任务问题</option>
                                    <option value="3">用户确认收货，好评问题</option>
                                    <option value="4">淘宝客/村淘投诉</option>
